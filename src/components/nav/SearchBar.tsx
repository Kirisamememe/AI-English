const SearchBar = () => {
    return (
        <div id={"search"} className={"transition-all duration-200 hover:bg-BlackOp-100 items-center w-[28rem] bg-BlackOp-50 gap-0.4 px-1.2 py-0.8 rounded-full"}>
            ...
            <input className={"form-input py-0 max-w-20 bg-transparent text-Gr-900 text-[1.6rem] focus:ring-0 border-none outline-none"} type={"text"} placeholder={"word or sentence"}/>
        </div>
    )
}
