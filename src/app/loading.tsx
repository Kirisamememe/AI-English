export default function Loading({className = "bg-Brand-50 w-full h-full", size = 48}: {className?: string, size?: number}) {

    return (
        <div className={`${className} justify-center items-center rounded-lg`}>
            <svg className={"animate-spin h-5 w-5 mr-3"} width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
